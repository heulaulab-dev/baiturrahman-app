			...
			>
				<div className="grid md:grid-cols-2 gap-8 items-center">
					{resolveBackendAssetUrl(featuredEvent.image_url ?? undefined) ? (
						...
						<div className="aspect-4/3 bg-linear-to-br from-[#1a3d2b]/10 to-[#b8962e]/10 flex items-center justify-center">
				...
				{otherEvents.slice(0, 3).map((event, index) => (
					...
					>
						{resolveBackendAssetUrl(event.image_url ?? undefined) ? (
							...
							<div className="aspect-[1/1.2] bg-linear-to-br from-sacred-green/5 to-sacred-gold/5 mb-4 flex items-center justify-center">
